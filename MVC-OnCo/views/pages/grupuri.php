            ...
            <div class="right">
                ...
                <div class="editProfile">
                    ...
                    <form action="#" class="form" method="POST" enctype="multipart/form-data">
                        ...
                        <?php
                                if($controllerGroups->editEmail == false) {
                                    echo '<p class="error"> Email already exists!</p>';
                                }else if($controllerGroups->editPassword == false){
                                    echo '<p class="error"> Passwords do not match!</p>';
                                }else if($controllerGroups->passwordRules == false){
                                    echo '<p class="error"> Passwords must be at least 6 in length and must contain at least a non-letter character!</p>';
                                } else if($controllerGroups->editStatus == true){
